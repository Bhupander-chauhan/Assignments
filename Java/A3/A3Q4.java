...
public class A3Q4 {
    ...
    public static void main(String[] args) 
    {
    	...
    	DateClass one=new DateClass(19,12,1998);
    	DateClass two=new DateClass(9,03,1999);
    	DateClass three=new DateClass(20,07,1998);
    	DateClass four=new DateClass(01,09,1999);
    	...
    	String employeeName="Sam,Navin,Tuvesh,Navpreet";
    	A3Q4 answer=new A3Q4();
